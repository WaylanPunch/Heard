package com.way.heard.utils.LogQuickSearchData;
...
public class LogQuickSearchRow extends LinearLayout {
    ...
    public void setLog(LogQuickSearch log) {
        mLog = log;
        Typeface roboto_regular = Typeface.createFromAsset(mContext.getAssets(), "fonts/RobotoSlab-Thin.ttf");
        TextView text = (TextView) findViewById(R.id.tv_quick_search_value);
